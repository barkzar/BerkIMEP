...
Rectangle {
    ...
    background: Rectangle {
      ...
      border.width:1
      gradient: Gradient {
        GradientStop { position: 0 ; color: homeButtonRota.pressed ? "#716F71" : "#DCDCDC" }
        GradientStop { position: 0.5 ; color: homeButtonRota.pressed ? "#716F71" : "#ABA8AC" }
        GradientStop { position: 1 ; color: homeButtonRota.pressed ? "#ABA8AC" : "#ABA8AC" }
      }
    }
    Label {
         text: "Back"
